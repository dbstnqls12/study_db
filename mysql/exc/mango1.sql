...
select
	...
	,a.tditTitle
	,a.tditSubTitle
	,avg((select b.ifcdReferenceI2 from infrcode b where b.ifcgSeq=26 and b.ifcdOrder = c.tditKcloverCd)) as tditKCloverCd -- 리뷰평균
    ...
    ,(select e.ifacNameEng from infrauthorcode e where e.ifacSeq = d.tdatAuthorCd) as tditAuthor	-- 원서정보/제목
	,a.tditBookDesc2
